...
/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Ingredient}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Ingredient> partialUpdateIngredient(
        ...
        Optional<Ingredient> result = ingredientRepository
            ...
            .map(existingIngredient -> {
                ...
                if (ingredient.getShop() != null) {
                    existingIngredient.setShop(ingredient.getShop());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, ingredient.getId().toString())
        );
    }
