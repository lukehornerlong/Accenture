...
export class CommentService {
  ...
  addCommentToComments(comment: string, rating: number, post: IPost, user: IUser): Observable<IComment> {
    const userComment = {
      comment,
      rating,
      post,
    ...
    return this.http.post<IComment>(this.resourceUrl, userComment);
  }
