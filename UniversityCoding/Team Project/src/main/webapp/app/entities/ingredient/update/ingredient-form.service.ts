...
type IngredientFormGroupContent = {
  ...
  ingredientName: FormControl<IIngredient['ingredientName']>;
  price: FormControl<IIngredient['price']>;
  shop: FormControl<IIngredient['shop']>;
  post: FormControl<IIngredient['post']>;
};
...
export class IngredientFormService {
  createIngredientFormGroup(ingredient: IngredientFormGroupInput = { id: null }): IngredientFormGroup {
    ...
    return new FormGroup<IngredientFormGroupContent>({
      ...
      ingredientName: new FormControl(ingredientRawValue.ingredientName),
      price: new FormControl(ingredientRawValue.price),
      shop: new FormControl(ingredientRawValue.shop),
      post: new FormControl(ingredientRawValue.post),
    });
  }
